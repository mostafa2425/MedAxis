...
export class HospitalController {
  async getAll(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      const { data, total } = await hospitalService.getAll(params);
  ...
  async create(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      const hospital = await hospitalService.create(parsed.data);
  ...
  async update(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      const hospital = await hospitalService.update(req.params.id as string, parsed.data);
  ...
  async delete(req: Request, res: Response, next: NextFunction) {
    try {
      await hospitalService.delete(req.params.id as string);

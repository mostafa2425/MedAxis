...
// @ts-nocheck 
/*
 * This file exports the `OperationTeamMember` model and its related types.
 *
...
export type GetOperationTeamMemberAggregateType<T extends OperationTeamMemberAggregateArgs> = {
      [P in keyof T & keyof AggregateOperationTeamMember]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateOperationTeamMember[P]>
    : Prisma.GetScalarType<T[P], AggregateOperationTeamMember[P]>
}
...
export type GetOperationTeamMemberGroupByPayload<T extends OperationTeamMemberGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<OperationTeamMemberGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof OperationTeamMemberGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], OperationTeamMemberGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], OperationTeamMemberGroupByOutputType[P]>
      }
    >
  >
...
export type OperationTeamMemberCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<OperationTeamMemberFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface OperationTeamMemberDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['OperationTeamMember'], meta: { name: 'OperationTeamMember' } }
  /**
   ...
   * })
  **/
  count<T extends OperationTeamMemberCountArgs>(
    args?: Prisma.Subset<T, OperationTeamMemberCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], OperationTeamMemberCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends OperationTeamMemberGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, OperationTeamMemberGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetOperationTeamMemberGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**

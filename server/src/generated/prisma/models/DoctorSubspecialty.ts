...
// @ts-nocheck 
/*
 * This file exports the `DoctorSubspecialty` model and its related types.
 *
...
export type GetDoctorSubspecialtyAggregateType<T extends DoctorSubspecialtyAggregateArgs> = {
      [P in keyof T & keyof AggregateDoctorSubspecialty]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateDoctorSubspecialty[P]>
    : Prisma.GetScalarType<T[P], AggregateDoctorSubspecialty[P]>
}
...
export type GetDoctorSubspecialtyGroupByPayload<T extends DoctorSubspecialtyGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<DoctorSubspecialtyGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof DoctorSubspecialtyGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], DoctorSubspecialtyGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], DoctorSubspecialtyGroupByOutputType[P]>
      }
    >
  >
...
export type DoctorSubspecialtyCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<DoctorSubspecialtyFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface DoctorSubspecialtyDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['DoctorSubspecialty'], meta: { name: 'DoctorSubspecialty' } }
  /**
   ...
   * })
  **/
  count<T extends DoctorSubspecialtyCountArgs>(
    args?: Prisma.Subset<T, DoctorSubspecialtyCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], DoctorSubspecialtyCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends DoctorSubspecialtyGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, DoctorSubspecialtyGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetDoctorSubspecialtyGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**

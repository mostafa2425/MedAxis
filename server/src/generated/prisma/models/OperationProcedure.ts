...
// @ts-nocheck 
/*
 * This file exports the `OperationProcedure` model and its related types.
 *
...
export type GetOperationProcedureAggregateType<T extends OperationProcedureAggregateArgs> = {
      [P in keyof T & keyof AggregateOperationProcedure]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateOperationProcedure[P]>
    : Prisma.GetScalarType<T[P], AggregateOperationProcedure[P]>
}
...
export type GetOperationProcedureGroupByPayload<T extends OperationProcedureGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<OperationProcedureGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof OperationProcedureGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], OperationProcedureGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], OperationProcedureGroupByOutputType[P]>
      }
    >
  >
...
export type OperationProcedureCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<OperationProcedureFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface OperationProcedureDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['OperationProcedure'], meta: { name: 'OperationProcedure' } }
  /**
   ...
   * })
  **/
  count<T extends OperationProcedureCountArgs>(
    args?: Prisma.Subset<T, OperationProcedureCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], OperationProcedureCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends OperationProcedureGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, OperationProcedureGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetOperationProcedureGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**

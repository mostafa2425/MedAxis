...
// @ts-nocheck 
/*
 * This file exports the `OperationMedicalTeam` model and its related types.
 *
...
export type GetOperationMedicalTeamAggregateType<T extends OperationMedicalTeamAggregateArgs> = {
      [P in keyof T & keyof AggregateOperationMedicalTeam]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateOperationMedicalTeam[P]>
    : Prisma.GetScalarType<T[P], AggregateOperationMedicalTeam[P]>
}
...
export type GetOperationMedicalTeamGroupByPayload<T extends OperationMedicalTeamGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<OperationMedicalTeamGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof OperationMedicalTeamGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], OperationMedicalTeamGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], OperationMedicalTeamGroupByOutputType[P]>
      }
    >
  >
...
export type OperationMedicalTeamCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<OperationMedicalTeamFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface OperationMedicalTeamDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['OperationMedicalTeam'], meta: { name: 'OperationMedicalTeam' } }
  /**
   ...
   * })
  **/
  count<T extends OperationMedicalTeamCountArgs>(
    args?: Prisma.Subset<T, OperationMedicalTeamCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], OperationMedicalTeamCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends OperationMedicalTeamGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, OperationMedicalTeamGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetOperationMedicalTeamGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
